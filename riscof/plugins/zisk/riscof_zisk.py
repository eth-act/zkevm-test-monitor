...
class zisk(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Path to the mounted ziskemu binary (following ziskof convention)
        # In Docker, ziskemu is mounted at /dut/bin/dut-exe
        # In ziskof, it was mounted at /program
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for zisk start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
