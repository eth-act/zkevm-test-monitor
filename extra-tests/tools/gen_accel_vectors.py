...
Usage (from the repository root):
    uv run --no-project --with pycryptodome --with ecdsa \\
        extra-tests/tools/gen_accel_vectors.py

Writes extra-tests/accelerators/vectors/<function>.h. The headers are checked
...
CACHE = Path.home() / ".cache" / "act-extra-geth" / GETH_COMMIT
